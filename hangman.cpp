 /*
 * ============================================================
 *  HANGMAN GAME — Months Edition  (C++ Backend)
 *  For First Year Students
 *
 *  NEW FEATURES:
 *  - Words are now the 12 months of the year
 *  - Each month has a HINT the player can ask for
 *  - Dashboard summary shown at end of each game
 *
 *  CONCEPTS USED:
 *  - struct  (grouping related data together)
 *  - vector  (dynamic list / array)
 *  - string  (text)
 *  - functions
